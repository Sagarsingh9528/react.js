    ...
    <div className="bg-slate-200 w-full min-h-screen">
      ...
      >
        <header className="w-[100%] flex justify-between items-center">
          ...
          <ImCross
            className="w-[20px] h-[20px] text-green-500 text-[18px] font-semibold cursor-pointer hover:text-gray-600"
        ...
        <div className="w-full border-t-2 border-b-2 border-gray-400 mt-7 flex flex-col gap-2 p-8">
          ...
          <div className="w-full flex justify-between items-center">
            <span className="text-lg text-gray-600 font-semibold">Taxis</span>
            <span className="text-green-400 font-semibold text-lg">
              Rs {taxes}/-
            </span>
          </div>
        ...
        <button className="w-[80%] p-3 bg-green-500 rounded-lg text-white hover:bg-green-500 transition-all">
          Place Order
        </button>
